...
export default function RequestCostPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      await createCostOut({ projectId, data: formData });
        ...
        <div className="mb-8 flex items-center gap-4">
          <div className="space-y-2">
            ...
            <Typography variant="body" className="text-muted-foreground">
              Ajukan Pengeluaran Baru Tiap Item WBS Disini
            </Typography>
          </div>
        </div>
                ...
                <div className="mt-4 space-y-4">
                  {fields.length === 0 ? (
                    <div className="rounded-lg border border-dashed bg-gray-50/50 py-12 text-center">
                      ...
                      >
                        Belum ada item yang ditambahkan. Mulai isi dengan klik
                        "Add New Item".
                      </Typography>
                    </div>
                  ) : (
